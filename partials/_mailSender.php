<?php
    ...
    while($row = mysqli_fetch_assoc($results)) {
        ...
        <body>
            ...
            <a href="http://localhost:8080/PHP_Coding/unsubscribe.php?email='.$email.'&unsub='.password_hash(strrev($email."rtCamp"),PASSWORD_BCRYPT).'"style="font-weight: 700;font-size:22 ">Unsubscribe</a>
            or
            "http://localhost:8080/PHP_Coding/unsubscribe.php?email='.$email.'&unsub='.password_hash(strrev($email."rtCamp"),PASSWORD_BCRYPT).'"
        </body>
        </html>
        ';
