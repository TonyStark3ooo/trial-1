<?php
    ...
    function mailVerifier($email){
        ...
        @font-face {
            ...
            src: url("https://janak-patel-rtc-assignment.herokuapp.com/Assets/fonts/sammyFont.woff2") format("woff2");
        }
                font-family: "sammyfont";
